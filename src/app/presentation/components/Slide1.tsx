      ...
      <div className="max-w-5xl w-full space-y-8">
        ...
        <div className="text-center space-y-8 min-h-[60vh] flex flex-col justify-center">
          ...
          <motion.div initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 1, delay: 0.3, type: "spring", stiffness: 100 }} className="space-y-6">
            <h1 className="text-6xl md:text-8xl font-black bg-gradient-to-r from-blue-400 via-purple-500 to-cyan-400 bg-clip-text text-transparent leading-tight">Kelompok 1</h1>

            {/* Team badge */}
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.6 }} className="inline-block">
              <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-4 rounded-full text-xl font-semibold shadow-2xl">👥 Tim Presentasi</div>
            </motion.div>
          </motion.div>
          ...
          <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.8 }} className="text-2xl md:text-3xl text-slate-300 font-light max-w-4xl mx-auto leading-relaxed">
            Presentasi Pengenalan Pemrograman & Sejarah Python
          </motion.p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-3xl mx-auto">
              {["Luqman", "Ilham", "Dafa", "Adit"].map((name, index) => (
                <motion.div
                  ...
                  className="group"
                >
                  <div className="bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-xl border border-slate-600/30 rounded-2xl p-6 transform transition-all duration-300 hover:scale-110 hover:rotate-2 hover:shadow-2xl hover:shadow-blue-500/25">
                    {/* Avatar placeholder */}
          ...
          >
            <div className="text-center space-y-4">
              ...
              <p className="text-xl text-blue-400 font-semibold">Pengenalan Pemrograman & Sejarah Python</p>
            </div>
          </motion.div>
        </div>
      </div>
